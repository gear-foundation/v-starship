import { MessageQueuedEvent, ProgramChangedEvent, UserMessageSentEvent } from '../types';
import { Event } from '../processor';

export function isUserMessageSentEvent(event: Event): event is UserMessageSentEvent {
...
export function isProgramChangedEvent(event: Event): event is ProgramChangedEvent {
